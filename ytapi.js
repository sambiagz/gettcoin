...
function execute() {
  return gapi.client.youtube.videos.list({
   ...
   <iframe width = "100%" height = "320" src = "https://www.youtube.com/embed/${video.id}" frameborder = "0" allow = "accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen ></iframe>
